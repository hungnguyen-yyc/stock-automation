namespace Stock.Shared
{
    ...
    {
#if !DEBUG
        public static readonly List<string> POPULAR_TICKERS = new List<string> { "ENB.TO", "SU.TO", "BNS.TO", "TD.TO", "RY.TO", "SHOP.TO", "BMO.TO", "BITF.TO", "CNQ.TO", "AC.TO", "T.TO", "MFC.TO", "SLF.TO"};
#else
