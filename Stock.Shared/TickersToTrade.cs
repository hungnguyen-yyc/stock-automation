namespace Stock.Shared
{
    ...
    {
#if !DEBUG
        public static readonly List<string> POPULAR_TICKERS = new List<string> { "AMD", "MSFT", "RIVN", "AAPL", "GOOGL", "TSLA", "NVDA", "META", "AMZN", "COIN", "RBLX", "SPY", "QQQ", "CAT", "DIS", "V", "AVGO", "SCHW", "MARA", "RIOT", "CVNA" };
#else
        public static readonly List<string> POPULAR_TICKERS = new List<string> { "NVDA" };
        ...
        //public static readonly List<string> POPULAR_TICKERS = new List<string> { "MARA", "RIOT", "CVNA", "AVGO", "SCHW" };
#endif
    }
}
